                    ...
                    <>
                        <div className="w-full h-screen relative sm:flex flex-col justify-center items-center overflow-hidden" >
                            ...
                            <div className="z-50 flex flex-col justify-center items-center  w-full h-3/4  ">
                                <h1 className="my-element animate__animated animate__flipInX animate__slower text-[3.5rem] mx-auto md:text-[4.8rem] lg:text-[5.8rem] xl:text-[6rem] 2xl:text-[6.3rem]  text-white font-bold sm:tracking-[0.6rem] tracking-[4.3px]" style={{
                                    fontFamily: "Oswald",
